"""
Simplified CAMI counselor without topic management.
Only keeps: State Inference → Strategy Selection → Generate → Refine
"""
...
# Build refinement chains (these don't depend on context imports)
...
class CAMISimple:
    """
    Simplified CAMI counselor without topic management.
    Pipeline: State Inference → Strategy Selection → Generate → Refine
...
The state of client is {state}, where {state_instruction}
"""
        candidate_responses = {}
        strategies = {}
